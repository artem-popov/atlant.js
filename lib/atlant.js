...
var _incStream = _dereq_('./inc/stream');

var _incBaseStreams = _dereq_("./inc/base-streams");

var _incBaseStreams2 = _interopRequireDefault(_incBaseStreams);

var _utilsLib = _dereq_('./utils/lib');

var _viewsViews = _dereq_("./views/views");
...
var build = _dereq_('./atlant-build');
var version = _dereq_('./atlant-version');
var s = _dereq_('./utils/lib');
var utils = _dereq_('./utils/utils');
var simpleRender = _dereq_('./renders/simple');
var reactRender = _dereq_('./renders/react');
var Bacon = window.Bacon;
var interfaces = _dereq_('./inc/interfaces');
var StateClass = _dereq_('./inc/state');
var clientFuncs = _dereq_('./inc/clientFuncs');
var Storage = _dereq_('./inc/storage');
var types = _dereq_('./inc/types');
var wrapHistoryApi = _dereq_('./inc/wrap-history-api.js').wrapHistoryApi;
var tools = _dereq_('./inc/tools');
...
function Atlant() {
    ...
    this.interceptor = function (fn) {
        var interceptorName = _utilsLib.uniqueId();
    ...
    this.streams = {
        ...
        reg: function reg(busOrName, fn, canBeIntercepted) {
            ...
            var busName = 'string' === typeof busOrName ? busOrName : _utilsLib.uniqueId();
...
},{"../utils/lib":16,"../utils/log":17}],6:[function(_dereq_,module,exports){
"use strict";
...
var baseStreams = _dereq_('./base-streams'),
    s = _dereq_('../utils/lib'),
    StateClass = _dereq_('./state'),
    types = _dereq_('./types'),
    interfaces = _dereq_('./interfaces'),
    clientFuncs = _dereq_('./clientFuncs'),
    utils = _dereq_('../utils/utils'),
    performance = _dereq_('./performance');
var Bacon = window.Bacon;
...
function ReadyStream(streamState, bus, stream) {
    ...
    Object.defineProperty(this, 'canBeIntercepted', { get: function get() {
            ...
            streamState.canBeIntercepted = value;
        } });
...
},{"../utils/lib":16,"../utils/log":17,"../utils/utils":18,"../views/views":19,"./base-streams":4,"./clientFuncs":5,"./interfaces":6,"./performance":7,"./state":8,"./types":12}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"../utils/lib":16,"../utils/utils":18}],12:[function(_dereq_,module,exports){
"use strict";
...
},{"../utils/lib":16,"../utils/log":17,"../utils/utils":18}],15:[function(_dereq_,module,exports){
/*
...
},{"./log":17}],17:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib":16}],18:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib":16}],19:[function(_dereq_,module,exports){
'use strict';
