...
function Atlant(){
    ...
    var _constructor = function(constructorProvider){
        ...
        stores[storeName].value = stores[storeName].updater.scan(constructorProvider(), function(state, updater){ return updater(state) } )  

        stores[storeName].value.onValue( function(value) { stores[storeName].staticValue = value } )
    ...
    var _updater = function(updaterName, updater){
        ...
        emitStreams[updaterName].onValue(function(scope){
            stores[storeName].storeUpdater.push( function(state){ return updater( state, scope) } )
        });
    ...
    var _part = function(partName, partProvider){
        ...
        if ( !('_constructor' in stores[storeName] )) { throw new Error("Constructor not implemented in store ", storeName)}
        ...
        stores[storeName].partsBus[partName] = stores[storeName].map;
...
},{"./atlant-build":1,"./atlant-version":2,"./counter.js":4,"./inc/clientFuncs":5,"./inc/dep-cache":6,"./inc/interfaces":7,"./inc/log":8,"./inc/state":9,"./inc/wrapPushState.js":10,"./lib":11,"./render-streams":12,"./renders/react":13,"./renders/simple":14,"./upstream.js":15,"./utils":16}],4:[function(_dereq_,module,exports){
"use strict"
...
},{"../lib":11,"./log":8}],6:[function(_dereq_,module,exports){
var s = _dereq_('../lib')
...
},{"../lib":11}],7:[function(_dereq_,module,exports){
"use strict";
