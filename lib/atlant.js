...
function Atlant() {
    ...
    var assignRenders = (function () {
        ...
        var subscribeView = function subscribeView(viewName, doRenderIntoView, scope, upstream) {
            ...
            viewSubscriptionsUnsubscribe[viewName] = viewSubscriptions[viewName].onValue((function (upstream, viewName, scope, doRenderIntoView, value) {
                ...
                window.selectTime = window.selectTime + performanceNow() - start;
                window.selectCount++;
    ...
    var _updater = function _updater(updaterName, updater) {
        ...
        baseStreams.onValue(emitStreams[updaterName], (function (storeName, updater, updaterName, scope) {
            // scope is the value of .update().with(scope) what was pushed in
            stores[storeName].changes.push((function (scope, updater, storeName, updaterName, state) {
...
},{"./atlant-build":1,"./atlant-version":2,"./counter.js":4,"./inc/base-streams":5,"./inc/clientFuncs":6,"./inc/interfaces":7,"./inc/log":8,"./inc/performanceNow":9,"./inc/state":10,"./inc/statistics":11,"./inc/storage":12,"./inc/tools":13,"./inc/types":14,"./inc/wrap-push-pop-states.js":15,"./lib":16,"./render-streams":17,"./renders/react":18,"./renders/simple":19,"./upstream.js":20,"./utils":21}],4:[function(require,module,exports){
"use strict";
...
},{"../lib":16,"./log":8}],7:[function(require,module,exports){
"use strict";
...
},{"../lib":16}],9:[function(require,module,exports){
"use strict";
...
},{"../lib":16,"../utils":21,"./tools":13}],12:[function(require,module,exports){
'use strict';
...
},{"../utils":21,"./../lib":16}],14:[function(require,module,exports){
"use strict";
...
},{"./lib":16,"./upstream.js":20}],18:[function(require,module,exports){
"use strict";
var s = require('./../lib'),
    _ = window._,
    u = require('../utils'),
...
},{"../inc/log":8,"../utils":21,"./../lib":16}],19:[function(require,module,exports){
/*
...
},{"./lib":16}],21:[function(require,module,exports){
"use strict";
