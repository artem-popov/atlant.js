...
function Atlant() {
    ...
    if (!Object.assign) Object.assign = _objectAssign2['default']; // Set polyfill for Object.assign
    ...
    this.interceptor = function (fn) {
        var interceptorName = _lodash.uniqueId();
...
},{"atlant-build":3,"atlant-version":4,"inc/base-streams":5,"inc/clientFuncs":6,"inc/interfaces":7,"inc/state":9,"inc/storage":10,"inc/stream":11,"inc/tools":12,"inc/types":13,"inc/wrap-history-api.js":14,"object-assign":1,"renders/react":15,"renders/simple":16,"utils/lib":17,"utils/log":18,"utils/utils":19,"views/views":20}],3:[function(require,module,exports){
"use strict";
...
},{"utils/lib":17,"utils/log":18}],7:[function(require,module,exports){
"use strict";
...
},{"inc/base-streams":5,"inc/clientFuncs":6,"inc/interfaces":7,"inc/performance":8,"inc/state":9,"inc/types":13,"utils/lib":17,"utils/log":18,"utils/utils":19,"views/views":20}],12:[function(require,module,exports){
"use strict";
...
},{"utils/lib":17,"utils/utils":19}],13:[function(require,module,exports){
"use strict";
        ...
        if (!wrappers[name]) {
            wrappers[name] = React.createClass({
                ...
                render: function render() {
                    ...
                    if (lodash.isArray(views[name])) return views[name][0](_extends({}, this.props, views[name][1]));else return views[name];
                }
            });
        }
        if (!instances[name]) {
...
},{"utils/lib":17,"utils/log":18,"utils/utils":19}],16:[function(require,module,exports){
/*
...
},{"utils/log":18}],18:[function(require,module,exports){
"use strict";
...
},{"utils/lib":17}],19:[function(require,module,exports){
"use strict";
...
},{"utils/lib":17}],20:[function(require,module,exports){
'use strict';
