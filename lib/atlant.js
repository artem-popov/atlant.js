...
function Atlant() {
    ...
    var s = _dereq_('utils/lib'),
        ...
        types = _dereq_('inc/types'),
        wrapPushState = _dereq_('inc/wrap-push-state.js').wrapPushState;
...
},{"atlant-build":2,"atlant-version":3,"inc/base-streams":4,"inc/clientFuncs":5,"inc/interfaces":6,"inc/state":8,"inc/storage":9,"inc/stream":10,"inc/tools":11,"inc/types":12,"inc/wrap-push-state.js":13,"renders/react":14,"renders/simple":15,"utils/lib":16,"utils/log":17,"utils/utils":18,"views/views":19}],2:[function(_dereq_,module,exports){
"use strict";
...
var baseStreams = _dereq_('inc/base-streams'),
    s = _dereq_('utils/lib'),
    StateClass = _dereq_('inc/state'),
    types = _dereq_('inc/types'),
    interfaces = _dereq_('inc/interfaces'),
    clientFuncs = _dereq_('inc/clientFuncs'),
    utils = _dereq_('utils/utils'),
    performance = _dereq_('inc/performance');
...
},{"inc/base-streams":4,"inc/clientFuncs":5,"inc/interfaces":6,"inc/performance":7,"inc/state":8,"inc/types":12,"utils/lib":16,"utils/utils":18,"views/views":19}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"utils/log":17}],17:[function(_dereq_,module,exports){
"use strict";
...
},{"utils/lib":16}],18:[function(_dereq_,module,exports){
"use strict";
...
},{"utils/lib":16}],19:[function(_dereq_,module,exports){
'use strict';
