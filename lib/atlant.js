...
function Atlant(){
    ...
    this.do =  _do;
    /**
     * Actually a shortcode of ".do()". Prints the scope which will be passed to ".render()". Use params as prefixes for logged data.
     */
    this.log =  _log;
    this.render =  _render;
    this.clear =  _clear;
...
},{"./../lib":4}],7:[function(_dereq_,module,exports){
/*
