...
function Atlant() {
        ...
        var assignRender = function assignRender(stream) {
            ...
            baseStreams.onValue(theStream, function (upstream) {
                ...
                try {
                    ...
                    var scopeFn = (function (viewName) {
                        return clientFuncs.createScope(savedViewScope[viewName]);
                    }).bind(void 0, viewName);
                    ...
                    if (types.RenderOperation.redirect === upstream.render.renderOperation) {
                        ...
                        var putInfo = function putInfo(atom, pushedValue) {
                            // When data arrived, get info from static scope of atom details
                        ...
                        viewSubscriptionsUnsubscribe[viewName] = viewSubscriptions[viewName].onValue((function (upstream, viewName, scopeFn, renderIntoView, atom) {
                            ...
                            if (!_.isEqual(data, viewData[viewName])) {
                                ...
                                var rendered = renderIntoView(data, function (_) {
                                    return _;
    ...
    var _depends = (function () {
        ...
        var createDepStream = function createDepStream(stream, depName, dep, injects, store, isAtom) {
                ...
                stream = stream.flatMap((function (store, depName, dep, isAtom, upstream) {
                    ...
                    var atomParams = (function (atomIds, scope, where, store, ref, isConsole, /*variable for debug*/parentRef) {
                        ...
                        if ('undefined' !== typeof store) {
                            ...
                            dependAtoms = (atomIds || []).map((function (aParentRef, atom) {
                                var atom_id = atom.fn(false, aParentRef);

                                var atomValue = s.tryF(void 0, function () {
                                    return atom.partProvider(atom.storeData.staticValue, atom_id);
                                })();
                    ...
                    return treatDep(dep)(atomParams(true)).mapError(function (_) {
            ...
            stream = stream.map((function (depName, store, injects, upstream) {
                ...
                if ('undefined' !== typeof store) {
                    var getValue = function getValue(ref, atomParams, store, upstream, firstTime, u) {
                        var source = store.storeData.staticValue;
                        var atomIdValue = atomParams(true);
                        var value = s.tryF(void 0, function () {
                            return s.copy(store.partProvider(source, atomIdValue));
                        })();
                    ...
                    var bus = store.bus.map(getValue.bind(void 0, stream.ref, stream.atomParams, store, _.extend({}, stream), false)).skipDuplicates(_.isEqual);

                    if (upstream.lastAtom) bus = bus
                ...
                return stream;
            }).bind(void 0, depName, store, injects)).mapError(function (_) {
    ...
    var checker = function checker(name, isFinished, isNeedToDecrease, signalStream, counter, object) {
        try {
            ...
            if (!(object.whenId in counter.list)) {
                /*console.log('no atoms here');*/return;
            } // no atoms here
            ...
            var routeChanged = (function (sink, event) {
                try {
                    ...
                    var state = function state(event) {
                        return 'pushstate' === event.type ? event.detail.state : 'popstate' === event.type ? event.state : void 0;
                    };
                    if ('pushstate' === event.type) {
     ...
     * @returns {*}
     */
    var _render = function _render(renderProvider, viewName, renderOperation) {
    ...
    var _select = function _select(isAtom, dependsBehaviour, partName, storeName) {
    ...
    this.render = function (renderProvider, viewName) {
        return _render.bind(this)(renderProvider, viewName, types.RenderOperation.render);
    };
    ...
    this.draw = function (renderProvider, viewName) {
        return _render.bind(this)(renderProvider, viewName, types.RenderOperation.draw);
    };
    /* clears default or provided viewName */
    this.clear = function (viewName) {
        return _render.bind(this)(function () {}, viewName, types.RenderOperation.clear);
    };
    // Soft atlant-inside redirect.
    this.redirect = function (redirectProvider) {
        return _render.bind(this)(redirectProvider, void 0, types.RenderOperation.redirect);
    };
    // Soft atlant-inside refresh.
    this.refresh = function (redirectProvider) {
        return _render.bind(this)(redirectProvider, void 0, types.RenderOperation.refresh);
    };
    ...
    this.replace = function (replaceProvider) {
        return _render.bind(this)(replaceProvider, void 0, types.RenderOperation.replace);
    };
    ...
    this.change = function (replaceProvider) {
        return _render.bind(this)(replaceProvider, void 0, types.RenderOperation.change);
    };
    ...
    this.move = function (redirectProvider) {
        return _render.bind(this)(redirectProvider, void 0, types.RenderOperation.move);
    };
    // render which render nothing into nowhere
    this.nope = function () {
        return _render.bind(this)(void 0, void 0, types.RenderOperation.nope);
    };
...
},{"../lib":15,"./log":8}],7:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":15}],9:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":15,"../utils":20,"./tools":12}],11:[function(_dereq_,module,exports){
'use strict';
...
},{"../utils":20,"./../lib":15}],13:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib":15,"./upstream.js":19}],17:[function(_dereq_,module,exports){
"use strict";
var s = _dereq_('./../lib'),
    _ = window._,
    u = _dereq_('../utils'),
...
},{"../inc/log":8,"../utils":20,"./../lib":15}],18:[function(_dereq_,module,exports){
/*
...
},{"./lib":15}],20:[function(_dereq_,module,exports){
"use strict";
