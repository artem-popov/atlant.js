...
function Atlant() {
    ...
    var _moveTo = function _moveTo(url) {
        if ('undefined' !== typeof window) return window.location.assign(url);else console.error('no window object...');
    };
...
},{"./atlant-build":1,"./atlant-version":2,"./inc/base-streams":4,"./inc/clientFuncs":5,"./inc/interfaces":6,"./inc/state":7,"./inc/storage":8,"./inc/stream":9,"./inc/tools":10,"./inc/types":11,"./inc/wrap-push-pop-states.js":12,"./lib":13,"./renders/react":14,"./renders/simple":15,"./utils":16,"./utils/log":17}],4:[function(require,module,exports){
"use strict";
...
var createScope = function createScope(upstream) {
    ...
    var warning = function warning(inject) {
        console.log('inject accessor return nothing:' + inject);
    };
...
},{"../lib":13,"../utils/log":17}],6:[function(require,module,exports){
"use strict";
...
},{"./../lib":13,"./base-streams":4,"./clientFuncs":5,"./interfaces":6,"./state":7,"./types":11}],10:[function(require,module,exports){
"use strict";
...
},{"../utils":16,"./../lib":13}],11:[function(require,module,exports){
"use strict";
...
},{"utils/log":18}],14:[function(require,module,exports){
"use strict";
var s = require('./../lib'),
    _ = window._,
    u = require('../utils'),
...
},{"../utils":16,"../utils/log":17,"./../lib":13}],15:[function(require,module,exports){
/*
