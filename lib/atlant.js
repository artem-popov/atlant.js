...
function Atlant() {
    ...
    var publishStream = _incBaseStreams2['default'].bus(); // Here we can put init things.
    var errorStream = _incBaseStreams2['default'].bus();
    ...
    var onDestroyStream = _incBaseStreams2['default'].bus();
    var onRenderEndStream = _incBaseStreams2['default'].bus();
    var onDrawEndStream = _incBaseStreams2['default'].bus();
    var onAtomEndStream = _incBaseStreams2['default'].bus();
    ...
    var atomEndSignal = _incBaseStreams2['default'].bus();
    var atomRecalculateSignal = _incBaseStreams2['default'].bus();

    var renderCounter = { list: {} };
    var isRendered = { value: false };
    var renderEndSignal = _incBaseStreams2['default'].bus();
    var renderRecalculateSignal = _incBaseStreams2['default'].bus();
    ...
    var otherwiseStream = _incBaseStreams2['default'].bus();
    ...
    var _onRenderEnd = function _onRenderEnd(callback) {
        ...
        _incBaseStreams2['default'].onValue(onBothEndStreams, s.baconTryD(callback));
        return this;
    };

    var _onDestroy = function _onDestroy(callback) {
        // Use this to get early callback for server render
        _incBaseStreams2['default'].onValue(onDestroyStream, s.baconTryD(callback));
        return this;
    };
    ...
    var _updater = function _updater(updaterName, updater) {
        ...
        _incBaseStreams2['default'].onValue(atlantState.emitStreams[updaterName], (function (storeName, updater, scope) {
    ...
    this.otherwise = function (fn) {
        return _action.call(this, otherwiseStream, fn, false, 'otherwise');
    };

    // Creates stream which will be called when render error is happend
    this.error = function (fn) {
        return _action.call(this, errorStream, fn, false, 'error');
    };
...
},{"./atlant-build":1,"./atlant-version":2,"./inc/base-streams":4,"./inc/clientFuncs":5,"./inc/interfaces":6,"./inc/log":7,"./inc/state":8,"./inc/statistics":9,"./inc/storage":10,"./inc/stream":11,"./inc/tools":12,"./inc/types":13,"./inc/wrap-push-pop-states.js":14,"./lib":15,"./renders/react":17,"./renders/simple":18,"./utils":19}],4:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":15,"./log":7}],6:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":15}],8:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":15,"../utils":19,"./tools":12}],10:[function(_dereq_,module,exports){
'use strict';
...
var _reactiveProperty = _dereq_("../reactive/property");
...
var baseStreams = _dereq_('./base-streams'),
    ...
    Stat = _dereq_('./statistics'),
    clientFuncs = _dereq_('./clientFuncs'),
    property = _dereq_('../reactive/property');
...
var Stream = function Stream(atlantState, prefs) {
    ...
    var streamState = {
        updates: _reactiveProperty.Property(function (_) {
            return 0;
        }),
        renders: 0,
        value: _reactiveProperty.Property(function (_) {
            return void 0;
        })
    };
        ...
        var subscribeView = function subscribeView(viewName, doRenderIntoView, scope, upstream) {
            ...
            viewSubscriptionsUnsubscribe[viewName] = viewSubscriptions[viewName].onValue((function (upstream, viewName, scope, doRenderIntoView, value) {
                ...
                return result.then((function (upstream, o) {
                    streamState.updates.swap(function (_) {
                        return _ - 1 / streamState.subscribersCount;
                    }); // if there is an subscription, then always do this
                    return o;
        ...
        return function (upstream) {
            ...
            try {
                ...
                if (types.RenderOperation.redirect === upstream.render.renderOperation) {
                    ...
                    var renderResult = doRenderIntoView(scope); // Here we using scope updated from store!
    ...
    var _render = (function () {
        var closeBlock = function closeBlock(renderOperation, viewName, _) {
            if (void 0 !== State.state.lastIf && renderOperation !== types.RenderOperation.draw) {
                State.rollback();
            }
        };
        var attachIfNeed = function attachIfNeed(renderOperation, viewName, _) {
            if ((renderOperation === types.RenderOperation.render || renderOperation === types.RenderOperation.draw) && viewName in prefs.attachedViews) {
                ...
                return prefs.render.attach(viewName, prefs.attachedViews[viewName])['catch'](function (e) {
                    console.error(e.message, e.stack);
                    errorStream.push(e);
                }).then(function (_) {
        ...
        return function (renderProvider, viewName, once, renderOperation) {
            ...
            var renderStream = State.state.lastOp.map(function (upstream) {
                ...
                return Bacon.fromPromise(renderView(upstream).then(attachIfNeed.bind(void 0, renderOperation, viewName)).then(function (_) {
                    return upstream;
                }));
            });
    ...
    this.push = function (_) {
        root.onValue(function (_) {
            return console.log("stream Oresult:", _), console.log('stream updates:', streamState.updates.unwrap());
        });
        root.push(_);
    };
...
},{"../reactive/property":16,"./../lib":15,"./base-streams":4,"./clientFuncs":5,"./interfaces":6,"./state":8,"./statistics":9,"./types":13}],12:[function(_dereq_,module,exports){
"use strict";
...
},{"../utils":19,"./../lib":15}],13:[function(_dereq_,module,exports){
"use strict";
...
function Property(value) {
    var stream = _incBaseStreams2["default"].bus();
    var value;
    var property = stream.scan(0, function (state, _) {
        return value = _(state);
    }, value);
    property.onValue(function (_) {
        return _;
    });
    return {
        swap: function swap(_) {
            return stream.push(_);
        },
        then: function then(_) {
            return property.onValue(_);
        },
        unwrap: function unwrap(_) {
            return value;
        },
        stream: property
    };
...
},{"../inc/base-streams":4}],17:[function(_dereq_,module,exports){
"use strict";
var s = _dereq_('./../lib'),
    _ = window._,
    u = _dereq_('../utils'),
...
var Render = function Render(React) {
    ...
    this.render = function (viewProvider, upstream, activeStreamId, name, scope) {
        var rendered = new Promise((function (name, upstream, activeStreamId, viewProvider, scope, resolve, reject) {
            ...
            if (rootName !== name && instance && instance.isMounted && instance.isMounted() && instance.forceUpdate) instance.forceUpdate(function (_) {
...
},{"../inc/log":7,"../utils":19,"./../lib":15}],18:[function(_dereq_,module,exports){
/*
