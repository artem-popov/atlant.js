...
exports["default"] = "30.06.2016";
module.exports = exports["default"];

},{}],99:[function(require,module,exports){
'use strict';

module.exports = '0.4.83';
...
function Atlant() {
    ...
    var _onUpdate = function _onUpdate(actionName, callback) {
        if (!(actionName in atlantState.callbacks.onUpdate)) atlantState.callbacks.onUpdate[actionName] = [];

        var index = atlantState.callbacks.onUpdate[actionName].push(callback);
...
},{"./atlant-build":98,"./atlant-version":99,"./inc/base-streams":101,"./inc/clientFuncs":102,"./inc/interfaces":103,"./inc/state":105,"./inc/storage":106,"./inc/stream":107,"./inc/tools":108,"./inc/types":109,"./inc/wrap-history-api.js":110,"./renders/react":111,"./renders/simple":112,"./utils/lib":113,"./utils/log":114,"./utils/utils":115,"./views":116}],101:[function(require,module,exports){
"use strict";
...
function AtlantStream(name, atlantState) {
    ...
    resolveBus.onValue(function (scope) {
        _utilsLog2['default'].warn('resolveBus!:', scope);
...
},{"../utils/lib":113,"../utils/log":114,"../utils/utils":115,"../views":116,"./base-streams":101,"./clientFuncs":102,"./interfaces":103,"./performance":104,"./state":105,"./types":109}],108:[function(require,module,exports){
"use strict";
            ...
            wrappers[name] = React.createClass({
                ...
                render: function render() {
                    ...
                    if (Array.isArray(views[name])) {
                        //came from .draw
                        var el = undefined;
                        var view = views[name][0];
                        var props = views[name][1];
                        if (typeof view == 'function') {
                            // .draw(props=><Component {...props}/>, 'myView')
                            if (!view.type) {
                                el = view(props) || React.createElement('noscript');
                            } else {
                                // react component, .draw(Component, 'myView')
...
},{"../utils/lib":113,"../utils/log":114,"../utils/utils":115}],112:[function(require,module,exports){
/*
