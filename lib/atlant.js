...
function Atlant() {
    ...
    _incBaseStreams2['default'].onValue(atlantState.streams.renderEndStream, s.baconTryD(function (_) {
        return console.log('render end:', _);
    }));
    ...
    this.otherwise = function (fn) {
        return _when.bind(this)('/otherwise', fn, types.Matching['continue'], types.WhenOrMatch.otherwise);
    };
...
},{"./atlant-build":1,"./atlant-version":2,"./inc/base-streams":4,"./inc/clientFuncs":5,"./inc/interfaces":6,"./inc/log":7,"./inc/state":8,"./inc/storage":9,"./inc/stream":10,"./inc/tools":11,"./inc/types":12,"./inc/wrap-push-pop-states.js":13,"./lib":14,"./renders/react":16,"./renders/simple":17,"./utils":18}],4:[function(require,module,exports){
"use strict";
...
},{"../lib":14,"./log":7}],6:[function(require,module,exports){
"use strict";
...
},{"../lib":14}],8:[function(require,module,exports){
"use strict";
...
},{"../reactive/property":15,"./../lib":14,"./base-streams":4,"./clientFuncs":5,"./interfaces":6,"./state":8,"./types":12}],11:[function(require,module,exports){
"use strict";
...
},{"../utils":18,"./../lib":14}],12:[function(require,module,exports){
"use strict";
...
function Property(initialValue) {
    ...
    var _name = void 0;
    var property = stream.scan(value, function (state, _) {
        return value = _(state), value;
    });
    ...
    return {
        swap: function swap(_) {
            return stream.push(_), _this;
        },
        then: function then(_) {
            return property.onValue(_), _this;
        },
        name: function name(_) {
            if (_) _name = _;return _ ? this : _name;
        },
...
},{"../inc/base-streams":4}],16:[function(require,module,exports){
"use strict";
var s = require('./../lib'),
    _ = window._,
    u = require('../utils'),
...
},{"../inc/log":7,"../utils":18,"./../lib":14}],17:[function(require,module,exports){
/*
