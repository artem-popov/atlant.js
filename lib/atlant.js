...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseStreams = __webpack_require__(9);
	...
	var _iterables = __webpack_require__(28);
	...
	var simpleRender = __webpack_require__(32);
	var reactRender = __webpack_require__(33);
	var Bacon = __webpack_require__(10);
	...
	var wrapHistoryApi = __webpack_require__(35).wrapHistoryApi;
	...
	function Atlant() {
	  ...
	  this.setContext = function (context) {
	    return atlantState.context = context;
	  };
	...
	function AtlantStream(name, atlantState) {
	  ...
	  */
	  ...
	  resolveBus.onValue(function (scope) {
	    _log3.default.warn('resolveBus!:', scope);
	  ...
	  var worker = function worker(depValue) {
	    ...
	    userStream.then(function (_) {
	      _log3.default.log('RenderEnd!:', _);resolve();
	    });

	    _log3.default.log('action', name, depValue);
	      ...
	      try {
	        ...
	        if (types.RenderOperation.redirect === upstream.render.renderOperation) {
	          ...
	          var renderResult = doRenderIntoView(scope).then(function () {
	            ...
	            _log3.default.error(e.message, e.stack);atlantState.devStreams.errorStream.push();return Bacon.End();
	          });
	    ...
	    return _depends.bind(this)(function (storeName, partName) {
	      return function (storeName, partName, id) {
	        ...
	        try {
	          ...
	          _log3.default.error('select', partName, 'from', storeName, 'failed:', e.message, e.stack);
	          value = void 0;
	        }
	        return value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var catchError = function catchError(e) {
	  if (e && e.stack) {
	    ...
	    _log2.default.error('Unknown error', e);
	  }
	  return e;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	utils.goTo = function (awaitLoad, url, awaitLoadForce, redirectForce) {
	  ...
	  if (typeof window === 'undefined') {
	    console.error('Here should be redirect to other page!');return;
	  }
	...
	utils.clearState = function () {
	  if (typeof window === 'undefined') {
	    console.error('Here should be Utils.clearState!');return;
	  }
	...
	utils.replace = function (url) {
	  if (typeof window === 'undefined') {
	    console.error('Here should be redirect to other page!', url);return;
	  }
	...
	utils.change = function (url) {
	  if (typeof window === 'undefined') {
	    console.error('Cannot apply url change on nodejs environment', url);return;
	  }
	...
	utils.attachGuardToLinks = function () {
	  if (typeof window === 'undefined') {
	    console.error('Will not attachGuardToLinks on server');return;
	  }
...
/***/ function(module, exports) {
	...
	function replaceState(state, title, location) {
	  if (!('history' in this)) console.warn('called history.replaceState', 'state:', state, 'title:', title, 'location:', location);
	  return 'history' in this ? this.history.replaceState(state, title, location) : void 0;
	}

	function pushState(state, title, location) {
	  if (!('history' in this)) console.warn('called history.pushState', 'state:', state, 'title:', title, 'location:', location);
	  return 'history' in this ? this.history.pushState(state, title, location) : void 0;
	}

	function getState() {
	  if (!('history' in this)) console.warn('called get state on history');
	  return history in this ? this.history.state : void 0;
	}

	function setState(state) {
	  if (!('history' in this)) console.warn('called set state on history', 'state:', state);
	  if (history in this) this.history.state = state;
	}

	function getLength() {
	  if (!('history' in this)) console.warn('called get length on history');
	  return history in this ? this.history.length : void 0;
	}

	function getScrollRestoration() {
	  if (!('history' in this)) console.warn('called get scroll restoration on history');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty4 = __webpack_require__(6);
