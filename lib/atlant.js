...
function Atlant(){
                ...
                .onValue( function(upstream){
                    try{ 
                        ...
                        if (RenderOperation.redirect === upstream.render.renderOperation ){
                            ...
                            console.log('---the atoms in render:', upstream.atoms)

                            // turn off all subscriptions of atoms for this view
                            console.log('--view subscriptions:', viewSubscriptions)
                            ...
                            viewSubscriptions[viewName] = _(upstream.atoms)
                                .reduce( function(bus, atom){
                                    return bus
                                        .merge(atom.bus)
                                        .map(function(pushedValue){ 
                            ...
                            viewSubscriptionsUnsubscribe[viewName] = viewSubscriptions[viewName].subscribe(function(atomValue){
        ...
        var createDepStream = function(stream, depName, dep, injects, store) {
            ...
            stream = stream
                ...
                .map(function(upstream) { // upstream.dependNames store name of all dependencies stored in upstream.
                    ...
                    if (atomId) stream.atoms[store.storeName + '.' + store.partName] = { id: atomId, store: store.storeName, atom: store.partName, bus: store.atomBus };
    ...
    var _store = function(storeName) {
        ...
        if ( !(storeName in stores) ) stores[storeName] = { updaters: {}, parts: {} ,partsBus: {} };
        return this;
    };
    ...
    var _part = function(partName, partProvider){
        ...
        stores[TopState.state.lastStoreName].partsBus[partName] = new Bacon.Bus();
    ...
    var _select = function(dependsBehaviour, partName, storeName) {
        ...
        return _depends.bind(this)( function(id){
            ...
            console.log('---the results:', result, storeName, partName, stores, storesData[storeName], id);
            var p = new Promise(function(resolve, reject){
               resolve(result); 
            })
            return p;
        }, dependsBehaviour, { storeName: storeName, partName: partName, atomBus: stores[storeName].partsBus[partName] } );
    }
    ...
    this.build = "1426776623129";
    // Returns commit id just before current atlant.js commit
    this.revision = "fd9d56550245c72391e70ef395cd7803fb86994d";
    this.utils = { 
        // test :: path -> mask -> Bool
        test: _test,
...
},{"./counter.js":2,"./inc/clientFuncs":3,"./inc/dep-cache":4,"./inc/interfaces":5,"./inc/log":6,"./inc/state":7,"./inc/wrapPushState.js":8,"./lib":9,"./render-streams":10,"./renders/react":11,"./renders/simple":12,"./upstream.js":13,"./utils":14}],2:[function(_dereq_,module,exports){
"use strict"
...
},{"../lib":9,"./log":6}],4:[function(_dereq_,module,exports){
var s = _dereq_('../lib')
...
},{"../lib":9}],5:[function(_dereq_,module,exports){
"use strict";
...
},{"../lib":9}],7:[function(_dereq_,module,exports){
"use strict";
...
},{"./lib":9,"./upstream.js":13}],11:[function(_dereq_,module,exports){
"use strict";
...
},{"../inc/log":6,"../utils":14,"./../lib":9}],12:[function(_dereq_,module,exports){
/*
...
},{"./lib":9}],14:[function(_dereq_,module,exports){
"use strict";
