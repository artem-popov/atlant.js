...
function Atlant(){
    ...
    var _constructor = function(constructorProvider){
        ...
        stores[storeName].value.changes().onValue( function(value) { stores[storeName].staticValue = value } )
    ...
    var _part = function(partName, partProvider){
        ...
        stores[storeName].partsBus[partName] = stores[storeName].value.map( function(store){return partProvider(store)}).changes();
